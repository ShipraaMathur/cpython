...
#define _IMP_OPEN_FOR_IMPORT_METHODDEF    \
    {"open_for_import", (PyCFunction)(void(*)(void))_imp_open_for_import, METH_FASTCALL|METH_KEYWORDS, _imp_open_for_import__doc__},

static PyObject *
_imp_open_for_import_impl(PyObject *module, PyObject *path);

static PyObject *
_imp_open_for_import(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
